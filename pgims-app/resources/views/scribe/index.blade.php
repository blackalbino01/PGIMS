...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="date"                data-endpoint="GETapi-reports-daily-sales"
               value="2025-09-19T20:04:20"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-09-19T20:04:20</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>store_id</code></b>&nbsp;&nbsp;
<small>integer[]</small>&nbsp;
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid date. Must be a date after or equal to <code>start</code>. Example: <code>2051-10-13</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>store_id</code></b>&nbsp;&nbsp;
<small>integer[]</small>&nbsp;
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/bank-accounts/16" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/bank-accounts/16"
);
